 ...
 */
final class Version20241008093908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercice (id INT AUTO_INCREMENT NOT NULL, question VARCHAR(255) DEFAULT NULL, reponse VARCHAR(255) DEFAULT NULL, theme_exo VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE realisation_exo_patient (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, feedback VARCHAR(255) DEFAULT NULL, resultat VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
