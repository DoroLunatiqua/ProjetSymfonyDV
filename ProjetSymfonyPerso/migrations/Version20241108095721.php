 ...
 */
final class Version20241108095721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE realisation_exo_patient (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, date DATETIME NOT NULL, feedback VARCHAR(255) DEFAULT NULL, resultat VARCHAR(255) DEFAULT NULL, question VARCHAR(255) DEFAULT NULL, question2 VARCHAR(255) DEFAULT NULL, question3 VARCHAR(255) DEFAULT NULL, question4 VARCHAR(255) DEFAULT NULL, question5 VARCHAR(255) DEFAULT NULL, INDEX IDX_E14F0B886B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
